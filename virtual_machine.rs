...
// 读取二进制文件
fn read_codes(file_path: &str) -> io::Result<Vec<Code>> {
...
// 初始化操作码映射
fn init_map() -> HashMap<String, Opt> {
...
// 模拟抽象机运行
fn test_machine(codes: &[Code], map: &HashMap<String, Opt>) {
