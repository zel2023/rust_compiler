...
pub fn compile(input_filename: &str, output_filename: &str) -> io::Result<()> {
...
// fn main() -> io::Result<()> {
//     let input_filename = "../dataset/in_if.txt";
...
//     let output_word = format!("../dataset/word_{}.txt", file_stem);

//     println!("{}", output_word);


//     compile(input_filename, &output_word);
